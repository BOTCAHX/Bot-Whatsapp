...
export var Eval = globalThis.Client.on("eval", async (data: HandlingData, Cli: ClientMessage) => {
...
export var Execute = globalThis.Client.on("execute", async (data: HandlingData, Cli: ClientMessage) => {
...
export var Publik = globalThis.Client.on("publik", async function (data: HandlingData, Cli: ClientMessage) {
...
export var Self = globalThis.Client.on("self", async function (data: HandlingData, Cli: ClientMessage) {
	const { from, id, config } = data;
...
export var ClearChat = globalThis.Client.on("clear-chat", async (data: HandlingData, Cli: ClientMessage) => {
	const { from, id } = data;
